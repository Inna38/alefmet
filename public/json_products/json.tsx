...
export const products = [
  {
    ...
    specs: {
      Щільність: "2.68 - 2.72 г/см³", // Залежить від сплаву, взято середнє значення
      "Температура плавлення": "570 - 660 °C", // Залежить від сплаву
      "Міцність на розрив": "230-290 МПа", // Залежить від сплаву (як у EN AB-46000)
      Твердість: "70-95 HB", // Залежить від сплаву
    },
